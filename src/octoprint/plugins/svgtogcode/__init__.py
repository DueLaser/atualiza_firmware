...
def discovery(self):
	...
	if not vendor:
		vendor = "Due laser"
		vendorUrl = "http://www.duelaser.com/"
...
class SvgToGcodePlugin(octoprint.plugin.SlicerPlugin,
	...
	def get_template_configs(self):
		return [
			dict(type = 'settings', name = "Parametros SVG", template='svgtogcode_settings.jinja2', custom_bindings = False),
			dict(type = 'generic', name = "Parametros SVG", custom_bindings = False)
		]
