...
def index():
	...
	templates["settings"]["entries"] = dict(
		...
		#serial=(gettext("Conexão"), dict(template="dialogs/settings/serialconnection.jinja2", _div="settings_serialConnection", custom_bindings=False)),
	...
	return render_template("due_index.jinja2", **render_kwargs)
