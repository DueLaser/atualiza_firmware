...
class MachineCom(object):
	...
	def _update_grbl_pos(self, line):
		...
		try:
			...
			mx = wx # apenas para funcionar
			my = wy # apenas para funcionar
	...
	def _mudaMira(novoValor):
		_miraLigada=novoValor		
	...
	def getStateString(self):
		...
		if self._state == self.STATE_OPEN_SERIAL:
			return "Abrindo porta serial"
		if self._state == self.STATE_DETECT_SERIAL:
			return "Detectando porta serial"
		...
		if self._state == self.STATE_ERROR:
			return "Erro: %s" % (self.getErrorString())
